...
const initDB = () => {
  ...
  if (row && row.count === 0) {
    ...
    const seedData = [
      ['Teknoloji', 'Apple MacBook Air M2', 'https://picsum.photos/seed/macbook/200/200', 31500, 34999, 'Apple TR', 'https://www.apple.com/tr/shop/buy-mac/macbook-air/13-inc-m2', 1, 0, 'TRY'],
